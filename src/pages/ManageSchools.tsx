    ...
    <div className="w-full h-full bg-white">
      ...
      <div className="px-6 py-4 bg-white flex items-center justify-between">
        <div className="flex gap-2">
          <Button
            variant="outline"
            className={`flex items-center gap-2 ${activeTab === 'list' ? 'bg-blue-600 text-white' : 'bg-white border-gray-300 text-black'}`}
          ...
          <Button
            variant="outline"
            className={`flex items-center gap-2 ${activeTab === 'add' ? 'bg-blue-600 text-white' : 'bg-white border-gray-300 text-black'}`}
            ...
            <div className="bg-white p-6 rounded-md shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <Input id="registrationDate" type="date" className="w-full border-gray-300 rounded bg-white px-3 py-2" />
                </div>
                <div>
