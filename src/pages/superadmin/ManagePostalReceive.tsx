...
export default function ManagePostalReceive() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Form submitted:", { schoolName, toTitle, reference, address, fromTitle, receiveDate, note });
    // Reset form
    setSchoolName("");
    setToTitle("");
    setReference("");
          ...
          <div className="px-6 py-4 bg-gray-50">
            <div className="flex items-center flex-wrap">
              ...
              <div className="flex items-center space-x-2 text-blue-600 text-sm flex-wrap">
                ...
                <span>|</span>
                <span className="font-semibold">Postal Receive</span>
              </div>
            </div>
          </div>
                ...
                <Table className="border-collapse min-w-full">
                  <TableHeader>
                    <TableRow className="border-b bg-gray-50">
                      ...
                      <TableHead className="border-r border-gray-200">Receive Date <Filter className="inline h-4 w-4" /></TableHead>
                      <TableHead>Action</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {postalReceives.length > 0 ? (
                      postalReceives.map((item) => (
                        <TableRow key={item.sl} className="border-b">
                          ...
                          <TableCell className="border-r border-gray-200">{item.receiveDate}</TableCell>
                          <TableCell>
            ...
            <div className="px-6 py-4 bg-white">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label htmlFor="receiveDate" className="block text-sm font-medium mb-2 text-right">
