...
export default function ManageSection() {
  ...
  // Sample data with Hindi school names
  const sections = [
    {
      sl: 1,
      school: "शासकीय क्वालिस विद्यालय",
      section: "A",
      class: "10th",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log({ school, sectionName, selectedClass, classTeacher, note });
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%239C92AC" fill-opacity="0.05"%3E%3Ccircle cx="30" cy="30" r="4"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }}>
      {/* Global Header Bar */}
      <div className="bg-white text-gray-900 px-6 py-4 flex items-center justify-between flex-wrap shadow-md border-b">
        <div className="flex items-center gap-4 flex-wrap">
          <Select>
            ...
            <SelectContent>
              <SelectItem value="school1">शासकीय क्वालिस विद्यालय</SelectItem>
              <SelectItem value="school2">Delhi International Public School</SelectItem>
            </SelectContent>
          </Select>
          <Select>
            <SelectTrigger className="w-48 bg-white text-gray-900">
        ...
        <div className="flex items-center gap-4 flex-wrap mt-2 md:mt-0">
          <Input placeholder="Global Search" className="w-48 bg-gray-50 text-gray-900 border-gray-300" />
        ...
        <CardContent className="p-0">
          ...
          <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b">
            <div className="flex items-center flex-wrap">
              ...
              <div className="flex items-center space-x-2 text-sm flex-wrap">
                <Link to="/superadmin/class" className="hover:underline text-blue-600 hover:text-blue-800">Class</Link>
                <span className="text-gray-400">|</span>
                <Link to="/superadmin/section" className="hover:underline font-bold text-blue-800">Section</Link>
                <span className="text-gray-400">|</span>
          ...
          <div className="px-6 py-4 bg-white flex gap-2 border-b">
            <Button
              ...
              className={`${activeTab === 'list' ? 'bg-purple-600 text-white hover:bg-purple-700' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'}`}
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-bold text-purple-800">Add Section</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-6 pt-4">
                  <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-4 items-start">
                    ...
                    {/* Section Name */}
                    <Label htmlFor="sectionName" className="text-right self-center text-indigo-800 font-bold">
                    ...
                    {/* Class */}
                    <Label htmlFor="class" className="text-right self-center text-indigo-800 font-bold pt-2">
                    ...
                    <Select value={classTeacher} onValueChange={setClassTeacher} required>
                      ...
                      <SelectContent>
                        <SelectItem value="teacher1">Rajesh Kumar</SelectItem>
                        <SelectItem value="teacher2">Priya Sharma</SelectItem>
                        <SelectItem value="teacher3">Amit Singh</SelectItem>
                        <SelectItem value="teacher4">Sunita Verma</SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                    <p className="text-sm text-gray-800">
                      <span className="font-bold text-yellow-800">Instruction:</span> Please add Teacher & Class before add Section.
                    </p>
                  </div>
                </form>
              </DialogContent>
              ...
              <div className="px-6 py-4 bg-white flex items-center justify-between flex-wrap gap-4 border-b">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      placeholder="Search..."
                      className="pl-10 w-52 bg-gray-50 border-gray-300"
                      value={searchTerm}
                ...
                <Table className="border-collapse min-w-full">
                  <TableHeader>
                    <TableRow className="bg-gradient-to-r from-gray-100 to-gray-200 border-b-2 border-gray-300">
                      ...
                      <TableHead className="border-r border-gray-300 font-bold text-gray-700">
                        Section <ChevronUp className="inline h-4 w-4 ml-1" />
                      </TableHead>
                      <TableHead className="border-r border-gray-300 font-bold text-gray-700">
                  ...
                  <TableBody>
                    {sections.map((section, index) => (
                      ...
                      >
                        <TableCell className="border-r border-gray-200 font-medium">{section.sl}</TableCell>
                        <TableCell className="border-r border-gray-200">{section.school}</TableCell>
                        <TableCell className="border-r border-gray-200 font-semibold text-purple-700">{section.section}</TableCell>
                        <TableCell className="border-r border-gray-200">{section.class}</TableCell>
                        <TableCell className="border-r border-gray-200">{section.classTeacher}</TableCell>
                        <TableCell>
