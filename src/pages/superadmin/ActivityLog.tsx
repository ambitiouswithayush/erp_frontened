...
export default function ActivityLog() {
  ...
  // State for activity log data (empty by default)
                  ...
                  <Table className="border-collapse min-w-full">
                    <TableHeader>
                      <TableRow className="border-b bg-gray-50">
                        ...
                        <TableHead className="border-r border-gray-200">User <ChevronUp className="inline h-4 w-4" /></TableHead>
                        <TableHead className="border-r border-gray-200">Activity <ChevronUp className="inline h-4 w-4" /></TableHead>
                        <TableHead className="border-r border-gray-200">Date</TableHead>
                        <TableHead className="border-r border-gray-200">IP Address</TableHead>
                      ...
                      {filteredActivityLogs.length > 0 ? (
                        filteredActivityLogs.map((log) => (
                          <TableRow key={log.sl} className="border-b">
                            ...
                            <TableCell className="border-r border-gray-200">{log.user}</TableCell>
                            <TableCell className="border-r border-gray-200">{log.activity}</TableCell>
                            <TableCell className="border-r border-gray-200">{log.date}</TableCell>
                            <TableCell className="border-r border-gray-200">{log.ipAddress}</TableCell>
                            <TableCell>
