...
export default function ManageWaitingApplication() {
  const [selectedRows, setSelectedRows] = useState("15");

  const waitingApplications = []; // Empty array for now, as per spec
          ...
          <div className="px-6 py-4 bg-gray-50">
            <div className="flex items-center flex-wrap">
              ...
              <div className="flex items-center space-x-2 text-blue-600 text-sm flex-wrap">
                ...
                <span>|</span>
                <span className="font-bold text-blue-800">Waiting Application</span>
                <span>|</span>
