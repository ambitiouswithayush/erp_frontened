...
import ManageVisitorPurpose from "./pages/ManageVisitorPurpose";
import ManageVisitorInfo from "./pages/ManageVisitorInfo";
import ManageCallLog from "./pages/ManageCallLog";
import ManagePostalDispatch from "./pages/ManagePostalDispatch";
import ManagePostalReceive from "./pages/ManagePostalReceive";
import ManageOpeningHour from "./pages/ManageOpeningHour";
import DatabaseBackup from "./pages/DatabaseBackup";
import ManageFeedback from "./pages/ManageFeedback";
import ActivityLog from "./pages/ActivityLog";
import ManageUserCredential from "./pages/ManageUserCredential";
import ResetUsername from "./pages/ResetUsername";
import DashboardLayout from "./components/DashboardLayout";
import ResetPasswordPage from "./pages/ResetPasswordPage";
import ManagePaymentSettingPage from "./pages/ManagePaymentSettingPage";
import ManageSMSSettingsPage from "./pages/ManageSMSSettingsPage";
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin/general" element={
              <ProtectedRoute>
                <AppLayout><GeneralSetting /></AppLayout>
              </ProtectedRoute>
            } />
            ...
            <Route path="/admin/reset-password" element={<ProtectedRoute><DashboardLayout title="Reset User Password" icon={<Settings className="h-6 w-6" />}><ResetPasswordPage /></DashboardLayout></ProtectedRoute>} />
            ...
            <Route path="/front-office/call-logs" element={<ProtectedRoute><AppLayout><ManageCallLog /></AppLayout></ProtectedRoute>} />
