...
import { ChevronUp, Calendar, Link, List, Search, FileText, Download, Copy } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="bg-blue-600 text-white px-6 py-4 rounded-t-lg flex items-center justify-between">
        ...
        <h1 className="text-xl font-semibold">Manage Academic Year</h1>
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-b border-gray-200">
              ...
              <TableHead className="font-bold text-gray-700">
                ?Is Running <ChevronUp className="inline h-3 w-3 ml-1" />
              </TableHead>
              <TableHead className="font-bold text-gray-700">
                Academic Year <ChevronUp className="inline h-3 w-3 ml-1" />
              </TableHead>
              <TableHead className="font-bold text-gray-700">
          ...
          <TableBody>
            <TableRow className="border-b border-gray-100">
              ...
              <TableCell className="text-gray-700">-</TableCell>
              <TableCell className="text-gray-700">Yes</TableCell>
              <TableCell className="text-gray-700">April 2025 - March 2026</TableCell>
